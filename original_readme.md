...
Have a look at the blog post for more details, as well as the `docs/quickstart.md` file for more information about how to set up your own deployment.

Below is the content of the original readme.md file from the PetClinic sample application.
